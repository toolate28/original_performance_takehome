        ...
        for round_num in range(rounds):
            ...
            if round_num == 0 or round_num == 11:
                ...
                for vec_base in range(0, n_vec_groups, UNROLL_FACTOR):
                    ...
                    for u in range(n):
                        vr = vregs[u]
                        body.append(("valu", ("-", vr['idx_vec'], two_vec, vr['t2_vec'])))
                ...
                # Broadcast constant 1 for comparison
                body.append(("valu", ("vbroadcast", const_1_vec, one_const)))
            ...
            for vec_base in range(0, n_vec_groups, UNROLL_FACTOR):
                ...
                # Use multiply_add to fuse idx*2 + offset into one operation
                for u in range(n):
                    vr = vregs[u]
                    body.append(("valu", ("multiply_add", vr['idx_vec'], vr['idx_vec'], two_vec, vr['t3_vec'])))
